...
export default function RegisterCollaborator() {
    ...
    function validateAll(): boolean {
        const newErrors: FormErrors = {
            ...
            organizacao: validateOrganization(organizacao) ?? undefined,
                ...
                >
                    ...
                    >
                        ...
                        <View style={styles.formWrapper}>
                            ...
                            {/* ORGANIZAÇÃO */}
                            <FieldLabel label="Organização:" fontFamily={questrial} />
                            <TextInput
                                ref={orgRef}
                                style={[
                                    styles.input,
                                    { fontFamily: questrial },
                                    errors.organizacao ? styles.inputError : null,
                                ]}
                                ...
                                onChangeText={(text) => {
                                    setOrganizacao(text);
                                    if (errors.organizacao) {
                                        setErrors((prev) => ({
                                            ...prev,
                                            organizacao: validateOrganization(text) ?? undefined,
                                        }));
                                    }
                                }}
                                ...
                                maxLength={100}
                                returnKeyType="next"
                                onSubmitEditing={() => setCityModalVisible(true)}
                            />
                            <ErrorText message={errors.organizacao} fontFamily={questrial} />
